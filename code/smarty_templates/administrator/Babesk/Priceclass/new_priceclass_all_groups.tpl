...
<p style="font-size: small;">Diese Standardwerte werden für alle Preisgruppen verwendet, deren Felder
Sie leer lassen.</p><br>
<label>Name der Preisklasse: <input type="text" name="name"></label><br><br>
{foreach $groups as $group} 
	<b>======Gruppe: {$group.name}======</b><br>
	<label>Preis für die Gruppe: <input type="text" name="group_price{$group.ID}" size="5"></label><br>
